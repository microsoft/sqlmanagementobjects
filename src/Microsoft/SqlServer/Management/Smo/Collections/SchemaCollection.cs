...
namespace Microsoft.SqlServer.Management.Smo
{
    ...
    public sealed  class SchemaCollection : SimpleObjectCollectionBase
	{
		...
		internal SchemaCollection(SqlSmoObject parentInstance)  : base(parentInstance)
		{
		}
		...
		public Schema this[Int32 index]
		{
			get
			{ 
				return GetObjectByIndex(index) as Schema;
			}
		}
		...
		public Schema this[string name]
		{
			get
			{
	    			    ...
	    			    return  GetObjectByName(name) as Schema;
