...
namespace Microsoft.SqlServer.Management.Smo
{
    ...
    public sealed  class SqlAssemblyCollection : SimpleObjectCollectionBase
	{
		...
		internal SqlAssemblyCollection(SqlSmoObject parentInstance)  : base(parentInstance)
		{
		}
		...
		public SqlAssembly this[Int32 index]
		{
			get
			{ 
				return GetObjectByIndex(index) as SqlAssembly;
			}
		}


		// returns wrapper class
		public SqlAssembly this[string name]
		{
			get
			{
	    			    ...
	    			    return  GetObjectByName(name) as SqlAssembly;
