...
namespace Microsoft.SqlServer.Management.Smo
{
    ...
    public sealed  class SearchPropertyListCollection : SimpleObjectCollectionBase
	{
		...
		internal SearchPropertyListCollection(SqlSmoObject parentInstance)  : base(parentInstance)
		{
		}
		...
		public SearchPropertyList this[Int32 index]
		{
			get
			{ 
				return GetObjectByIndex(index) as SearchPropertyList;
			}
		}


		// returns wrapper class
		public SearchPropertyList this[string name]
		{
			get
			{
	    			    ...
	    			    return  GetObjectByName(name) as SearchPropertyList;
