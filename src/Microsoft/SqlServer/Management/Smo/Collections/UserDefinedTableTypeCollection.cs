...
namespace Microsoft.SqlServer.Management.Smo
{
    ...
    public sealed class UserDefinedTableTypeCollection : SchemaCollectionBase
	{
		...
		internal UserDefinedTableTypeCollection(SqlSmoObject parentInstance)  : base(parentInstance)
		{
		}
		...
		public UserDefinedTableType this[Int32 index]
		{
			get
			{ 
				return GetObjectByIndex(index) as UserDefinedTableType;
			}
		}
		...
		internal override SqlSmoObject GetCollectionElementInstance(ObjectKeyBase key, SqlSmoState state)
		{
			...
			{
				if( null == userDefinedTableType )
					throw new FailedOperationException(ExceptionTemplates.AddCollection, this, new ArgumentNullException("userDefinedTableType"));
