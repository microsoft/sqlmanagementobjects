...
namespace Microsoft.SqlServer.Management.Smo
{
    ...
    public sealed  class DatabaseRoleCollection : SimpleObjectCollectionBase
	{
		...
		internal DatabaseRoleCollection(SqlSmoObject parentInstance)  : base(parentInstance)
		{
		}
		...
		public DatabaseRole this[Int32 index]
		{
			get
			{ 
				return GetObjectByIndex(index) as DatabaseRole;
			}
		}


		// returns wrapper class
		public DatabaseRole this[string name]
		{
			get
			{
	    			    ...
	    			    return  GetObjectByName(name) as DatabaseRole;
