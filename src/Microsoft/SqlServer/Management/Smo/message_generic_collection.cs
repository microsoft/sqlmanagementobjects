...
namespace NAMESPACE_NAME
{
	...
	///</summary>
	public SEALED_IMP class TOKEN_PASTE( MAPPED_TYPE, COLLECTION_SUFFIX) : MessageCollectionBase
	{
		...
		public MAPPED_TYPE this[Int32 id, string language]
		{
			get
			{
				return  GetObjectByKey(new MessageObjectKey(id, language)) as MAPPED_TYPE;
			}
		}

		public MAPPED_TYPE ItemByIdAndLanguage(Int32 id, string language)
		{
			return this[id, language];
		}

		public MAPPED_TYPE ItemByIdAndLanguageId(Int32 id, Int32 languageId)
		{
