...
namespace Microsoft.SqlServer.Management.XEvent
{
    ...
    /// </summary>
    public sealed class PredCompareInfo : SfcInstance, IXEObjectInfo
    {
        /// <summary>
        /// Type name
        /// </summary>
        public const string TypeTypeName = "PredCompareInfo";
        /// <summary>
        /// Initializes a new instance of the <see cref="PredCompareInfo"/> class.
        /// </summary>
        internal PredCompareInfo()
        {
        }
        ...
        public sealed class Key : SfcKey
        {
            ...
            {
                return String.Format(CultureInfo.InvariantCulture, "{0}[@Name='{1}']", PredCompareInfo.TypeTypeName, SfcSecureString.EscapeSquote(Name));
            }
        }
        ...
        public Guid TypePackageID
        {
            get
            {
                return (Guid)this.Properties["TypePackageID"].Value;
            }
        }
