...
namespace Microsoft.SqlServer.Management.XEvent
{
    ...
    /// </summary>
    public sealed class TypeInfo : SfcInstance, IXEObjectInfo
    {
        /// <summary>
        /// Type name
        /// </summary>
        public const string TypeTypeName = "TypeInfo";
        ...
        public sealed class Key : SfcKey
        {
            ...
            {
                return String.Format(CultureInfo.InvariantCulture, "{0}[@Name='{1}']", TypeInfo.TypeTypeName, SfcSecureString.EscapeSquote(Name));
            }
        }
        ...
        public int Size
        {
            get
            {
                SfcProperty p = this.Properties["Size"];
                return (int)p.Value;
            }
        }
