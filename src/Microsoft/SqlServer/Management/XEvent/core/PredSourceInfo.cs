...
namespace Microsoft.SqlServer.Management.XEvent
{
    ...
    /// </summary>
    public sealed class PredSourceInfo : SfcInstance, IXEObjectInfo
    {
        /// <summary>
        /// Type name
        /// </summary>
        public const string TypeTypeName = "PredSourceInfo";


        /// <summary>
        /// Default constructor
        /// </summary>
        internal PredSourceInfo()
        {
        }
        ...
        public sealed class Key : SfcKey
        {
            ...
            {
                return String.Format(CultureInfo.InvariantCulture, "{0}[@Name='{1}']", PredSourceInfo.TypeTypeName, SfcSecureString.EscapeSquote(Name));
            }
        }
