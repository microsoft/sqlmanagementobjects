...
namespace Microsoft.SqlServer.Management.XEvent
{
    ...
    public sealed class DataEventColumnInfo : SfcInstance
    {
        ...
        /// Type name
        /// </summary>
        public const string TypeTypeName = "DataEventColumnInfo";
  
        /// <summary>
        /// Default constructor
        /// </summary>
        internal DataEventColumnInfo()
        {
        }
        ...
        public sealed class Key : SfcKey
        {
            ...
            {
                return String.Format(CultureInfo.InvariantCulture, "{0}[@Name='{1}']", DataEventColumnInfo.TypeTypeName, SfcSecureString.EscapeSquote(Name));
            }
        }
        ...
        internal sealed class ObjectFactory : SfcObjectFactory
        {
            ...
            {
                return new DataEventColumnInfo();
            }
        }
