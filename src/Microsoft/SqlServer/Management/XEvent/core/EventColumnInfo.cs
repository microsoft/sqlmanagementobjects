...
namespace Microsoft.SqlServer.Management.XEvent
{
    ...
    public sealed class EventColumnInfo : SfcInstance
    {
        ...
        /// Type name
        /// </summary>
        public const string TypeTypeName = "EventColumnInfo";

        /// <summary>
        /// Default constructor
        /// </summary>
        internal EventColumnInfo()
        {
        }
        ...
        public sealed class Key : SfcKey
        {
            ...
            {
                return String.Format(CultureInfo.InvariantCulture, "{0}[@Name='{1}']", EventColumnInfo.TypeTypeName, SfcSecureString.EscapeSquote(Name));
            }
        }
