...
namespace Microsoft.SqlServer.Management.Dmf
{
...
#endif
    public sealed partial class ConnectionEvaluationHistory : SfcInstance
    {
        static TraceContext traceContext = TraceContext.GetTraceContext("DMF", "ConnectionEvaluationHistory");
        internal const string typeName = "ConnectionEvaluationHistory";

        /// <summary>
        /// 
        /// </summary>
        public ConnectionEvaluationHistory()
        {
        ...
        {
            traceContext.TraceMethodEnter("ConnectionEvaluationHistory");
            // Tracing Input Parameters
            traceContext.TraceParameters(parent);
            this.Parent = parent;
            traceContext.TraceMethodExit("ConnectionEvaluationHistory");
        }
        ...
        public Int32 EvaluationId
        {
            get
            {
                object value = this.Properties["EvaluationId"].Value;
                if (value == null)
                    return 0;
                return (Int32)value;
            }
        ...
        public String ServerInstance
        {
            get
            {
                object instanceName = Properties["ServerInstance"].Value;
            ...
            internal set
            {
                traceContext.TraceVerbose("Setting ServerInstance to: {0}", value);
                Properties["ServerInstance"].Value = value;
            }
        }
        ...
        public new EvaluationHistory Parent
        {
            get { return (EvaluationHistory)base.Parent; }
            internal set
            {
        ...
        EvaluationDetailCollection evaluationHistories;

        /// <summary>
        /// 
        /// </summary>
        [SfcObject(SfcContainerRelationship.ChildContainer, SfcContainerCardinality.ZeroToAny, typeof(EvaluationDetail))]
        public EvaluationDetailCollection EvaluationDetails
        {
            get
            {
                if (this.evaluationHistories == null)
                {
                    this.evaluationHistories = new EvaluationDetailCollection(this);
                }
        ...
        public override void Discover(ISfcDependencyDiscoveryObjectSink sink)
        {
            switch (sink.Action)
            {
                case SfcDependencyAction.Serialize:
                    EvaluationDetailCollection histories = this.EvaluationDetails;
                    if (histories != null)
                    {
    ...
    [System.Security.Permissions.StrongNameIdentityPermission(System.Security.Permissions.SecurityAction.LinkDemand, PublicKey = DmfConstants.MICROSOFT_SQLSERVER_PUBLIC_KEY)]
        ...
        sealed class ObjectFactory : SfcObjectFactory
        {
            ...
            {
                return new ConnectionEvaluationHistory();
            }
